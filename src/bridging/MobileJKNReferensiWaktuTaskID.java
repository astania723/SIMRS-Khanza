 ...
 * @author dosen
 */
public final class MobileJKNReferensiWaktuTaskID extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MobileJKNReferensiWaktuTaskID(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                //"No.Rawat","No.RM","Nama Pasien","No.HP","No.Kartu","NIK","Tanggal","Poliklinik","Dokter","Jam Praktek","Jenis Kunjungan","Nomor Referensi","Status","Validasi Checkin","No.Booking"
                  "No.Rawat","No.RM","Nama Pasien","TaskID 3","TaskID 4","TaskID 5","TaskID 6","TaskID 7","Status"
            }){
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MobileJKNReferensiWaktuTaskID dialog = new MobileJKNReferensiWaktuTaskID(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   "SELECT referensi_mobilejkn_bpjs.no_rawat,referensi_mobilejkn_bpjs.norm,pasien.nm_pasien,"+
                           "referensi_mobilejkn_bpjs.validasi,pemeriksaan_ralan.jam_rawat,reg_periksa.stts,resep_obat.jam,resep_obat.jam_penyerahan"+
                   ...
                   "FROM referensi_mobilejkn_bpjs INNER JOIN pasien ON referensi_mobilejkn_bpjs.norm=pasien.no_rkm_medis "+
                           "INNER JOIN pemeriksaan_ralan ON  referensi_mobilejkn_bpjs.no_rawat=pemeriksaan_ralan.no_rawat "+
                           "INNER JOIN reg_periksa ON referensi_mobilejkn_bpjs.no_rawat=reg_periksa.no_rawat "+
                           "INNER JOIN resep_obat ON referensi_mobilejkn_bpjs.no_rawat=resep_obat.no_rawat "+
                   "WHERE referensi_mobilejkn_bpjs.tanggalperiksa BETWEEN ? AND ? "+(TCari.getText().equals("")?"": 
                   "and (referensi_mobilejkn_bpjs.no_rawat LIKE ? OR referensi_mobilejkn_bpjs.norm LIKE ? OR pasien.nm_pasien LIKE ?) "+
                   "and pemeriksaan_ralan.no_rawat Like ? and reg_periksa.stts='Sudah' and reg_periksa.no_rawat between "+
                   "and resep_obat.tgl_perawatan<>'0000-00-00' and resep_obat.status='ralan' and resep_obat.no_rawat between "+
                   "and resep_obat.status='ralan' and resep_obat.no_rawat=? and concat(resep_obat.tgl_penyerahan,' ',resep_obat.jam_penyerahan)<>'0000-00-00 00:00:00' between") +
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("validasi"),rs.getString("jam_rawat"),rs.getString("stts"),
                        rs.getString("jam"),rs.getString("jam_penyerahan"),rs.getString("status")
                    });
                }
            } catch (Exception e) {
