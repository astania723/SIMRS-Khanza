 ...
 * @author perpustakaan
 */
public class DlgKeteranganPenunjangKasir extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgKeteranganPenunjangKasir(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        tabModeLab=new DefaultTableModel(null,new Object[]{
            "No.Permintaan","Tanggal","Jam","Nama Pemeriksaan","Dokter Perujuk","Status Pembayaran"
            }){
...
//        TCatatan.setWrapStyleWord(true);
    ...
    private void initComponents() {
        ...
        MnBayarTagihan = new javax.swing.JMenuItem();
        ...
        MnBayarTagihan.setBackground(new java.awt.Color(255, 255, 254));
        MnBayarTagihan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnBayarTagihan.setForeground(new java.awt.Color(50, 50, 50));
        MnBayarTagihan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnBayarTagihan.setText("Bayar Tagihan");
        MnBayarTagihan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnBayarTagihan.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnBayarTagihan.setName("MnBayarTagihan"); // NOI18N
        MnBayarTagihan.setPreferredSize(new java.awt.Dimension(250, 25));
        MnBayarTagihan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnBayarTagihanActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnBayarTagihan);
    ...
    private void MnBayarTagihanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBayarTagihanActionPerformed
        
    }//GEN-LAST:event_MnBayarTagihanActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKeteranganPenunjangKasir dialog = new DlgKeteranganPenunjangKasir(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JMenuItem MnBayarTagihan;
    ...
    private void keterangan(){
            try {
                    ...
                    pscarilab=koneksi.prepareStatement("select permintaan_lab.noorder,permintaan_lab.tgl_permintaan,"+
                        "if(permintaan_lab.jam_permintaan='00:00:00','',permintaan_lab.jam_permintaan) as jam_permintaan,jns_perawatan_lab.nm_perawatan,jns_perawatan_lab.total_byr,"+
                    ...
                    try {
                        ...
                        while(rscarilab.next()){
                            tabModeLab.addRow(new String[]{
                                rscarilab.getString("noorder"),rscarilab.getString("tgl_permintaan"),rscarilab.getString("jam_permintaan"),"",
                                rscarilab.getString("nm_dokter"),Sequel.cariIsi("select status_pembayaran_lab.status from status_pembayaran_lab where status_pembayaran_lab.noorder='"+rscarilab.getString("noorder")+"'")
                            });
//                    tabModeLab.addRow(new String[]{"","","","",""});                
                    ps=koneksi.prepareStatement("select jns_perawatan_lab.nm_perawatan " +
                    "from permintaan_lab inner join permintaan_detail_permintaan_lab on permintaan_lab.noorder=permintaan_detail_permintaan_lab.noorder "+
                    "inner join jns_perawatan_lab on permintaan_detail_permintaan_lab.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw "+
                    "where permintaan_lab.noorder=? group by jns_perawatan_lab.kd_jenis_prw order by permintaan_lab.tgl_permintaan,permintaan_lab.jam_permintaan desc");
                    try {
                        ps.setString(1,rscarilab.getString("noorder"));
                        rs=ps.executeQuery();
                        while(rs.next()){
                            tabModeLab.addRow(new String[]{
                    ...
                    try {
                        ...
                        while(rscariradiologi.next()){
                            tabModeRad.addRow(new String[]{
                                rscariradiologi.getString("noorder"),rscariradiologi.getString("tgl_permintaan"),rscariradiologi.getString("jam_permintaan"),"",rscariradiologi.getString("nm_dokter"),Sequel.cariIsi("select status_pembayaran_radiologi.status from status_pembayaran_radiologi where status_pembayaran_radiologi.noorder='"+rscariradiologi.getString("noorder")+"'")
                            });
                    ps=koneksi.prepareStatement("select jns_perawatan_radiologi.nm_perawatan " +
                        "from permintaan_radiologi inner join permintaan_pemeriksaan_radiologi on permintaan_radiologi.noorder=permintaan_pemeriksaan_radiologi.noorder "+
                        "inner join jns_perawatan_radiologi on permintaan_pemeriksaan_radiologi.kd_jenis_prw=jns_perawatan_radiologi.kd_jenis_prw "+
                        "where permintaan_radiologi.noorder=? group by jns_perawatan_radiologi.kd_jenis_prw order by permintaan_radiologi.tgl_permintaan,permintaan_radiologi.jam_permintaan desc");
                    try {
                        ps.setString(1,rscariradiologi.getString("noorder"));
                        rs=ps.executeQuery();
                        while(rs.next()){
                            tabModeRad.addRow(new String[]{
                                "","","",rs.getString("nm_perawatan"),""
