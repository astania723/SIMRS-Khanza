 ...
 * @author perpustakaan
 */
public class DlgViewPdfSurat extends javax.swing.JDialog {
    ...
    DlgPassPhraseSurat passphrase=new DlgPassPhraseSurat(null,true);

    /** Creates new form DlgPemberianObat
     * @param parent
     * @param modal */
    public DlgViewPdfSurat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//            viewpdf(); 
    ...
    if(Sequel.cariInteger("select count(nama_file) from berkas_tte_surat where nama_file='"+txtNameFile.getText()+"'")>0){
       LocationFile="server"; 
       setButton(false);
       deleteFile();
    }else{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgViewPdfSurat dialog = new DlgViewPdfSurat(new javax.swing.JFrame(), true);
