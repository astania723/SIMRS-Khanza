 ...
 * @author perpustakaan
 */
public class DlgPassPhraseNarkoba extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPassPhraseNarkoba(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
                ...
                metadata = root.path("metadata");
                 ...
                 JOptionPane.showMessageDialog(null,metadata.path("message").asText());        
                        if(metadata.path("code").asText().equals("200")){
                            Sequel.menyimpantf("berkas_tte_narkoba","?,?,?,?,?,?,?","No.Rawat",7,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPassPhraseNarkoba dialog = new DlgPassPhraseNarkoba(new javax.swing.JFrame(), true);
    ...
    public void setNamaFile(String namaFile,String pathFile,String NoRawat) {
        txtNik.setText(Sequel.cariIsi("select no_ktp from pegawai where pegawai.nik=?",akses.getkode()));
